...
2. Copy `webproject` to `C:/inetpub/wwwroot/bengomallapi`

3. Install Python 3.7 in `C:/Python311`, and install the necessary libraries `django`, `openpyxl`, `wfastcgi`; see `bengomallapi/install_requirements.bat`

4. Navigate to `C:/`, right-click on `Python311`, and edit `Properties`. Under Security, add `IIS AppPool\DefaultAppPool`. `DefaultAppPool` is the default app pool.
